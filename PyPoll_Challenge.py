...
# the data required by the stakeholder
...
with open(file_to_load) as election_data:
    ...
    # For each row in the CSV file (starting in the seoncd row)
    for row in reader:
    ...
    # I have iterated over all rows in csv file
...
with open(file_to_save, "w") as txt_file:
    ...
    for county in county_votes:
        ...
        # county_percentage = float(county_vote) / float(total_vote) * 100
        ...
        # write the f string to the text file
